...
//   status: string;
//   image: string;
//   mode?: 'order' | 'wishlist'; // ✅ optional
//   onRemove?: () => Promise<void> | void; // ✅ support async remove
// }
...
//     try {
//       setIsRemoving(true);
//       await onRemove?.(); // call remove function
...
//           <img className="h-16 w-11 object-contain" src={image} alt={title} />
//         </div>
...
//           {/* If mode is 'order', show price, else show Remove button */}
//           {mode === 'order' ? (
...
//                   variant="ghost"
//                   size="sm"
//                   disabled={isRemoving} // disable during loading
...
//                   <AlertDialogDescription>
//                     This action will remove the item from your wishlist. You can't undo this.
//                   </AlertDialogDescription>
//                 </AlertDialogHeader>
//                 <AlertDialogFooter>
