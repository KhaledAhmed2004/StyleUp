  ...
  return (
    <div>
      ...
      <section className="mt-[176px] h-[200px] bg-neutral-white-w100">
        <div className="mx-auto flex max-w-7xl items-center justify-between py-[59px]">
          <div>
            {/* Title */}
            <h3 className="mb-[24px] heading-h3-normal-bold text-neutral-black-b900">
              Join Our Newsletter{' '}
            </h3>
            {/* Description */}
          ...
          <div>
            <div className="flex w-full items-center space-x-4">
              <Input
                className="w-[320px] rounded-[6px] !bg-neutral-white-w100 px-[15px] py-[10px]"
                type="email"
                placeholder="Your email address"
              />
              <Button
                className="px-[24px] py-[12px] body-medium text-[12px]"
                type="submit"
              >
                Subscribe
              </Button>
